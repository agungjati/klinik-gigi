...
<body>
                    ...
                    <div class="col-12">
                        <div class="bg-white rounded h-100 p-4 shadow-sm">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h6 class="mb-0">Peralatan & Obat</h6>
                                <div class="d-flex" >
    ...
    @include('./item/goods/modal-edit')
    @include('./item/goods/modal-add')
    ...
    <script>
        ...
        function getAllItems(search = '', gotoPage = 0) {
            ...
            $.ajax({
                url: '/api/items?search=' + search + '&offset=' + offset,
                type: 'GET',
                beforeSend: function(xhr) {
                    $('#exam-table tbody').html('<tr><td colspan="7" class="text-center">Loading...</td></tr>');
                },
                ...
                error: function(error) {
                    $('#exam-table tbody').html('<tr><td colspan="7" class="text-center">No data found</td></tr>');
                }
            });
        }
        ...
        $(document).ready(function handleUpdate() {
            $('#modal-edit').on('shown.bs.modal', function loadData() {
                ...
                $('#modal-edit #inputStock').val(selectedItem.item_stock);
        ...
        $(document).ready(function handleAdd() {
            ...
            $('#form-add').submit(function(e) {
                ...
                const data = {
                    ...
                    item_stock: $('#modal-add #inputStock').val(),
