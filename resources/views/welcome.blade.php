                ...
                <div class="owl-carousel header-carousel">
                    <div class="owl-carousel-item position-relative">
                        ...
                        <div class="owl-carousel-text">
                            <h1 class="display-1 text-white mb-0">Spesialis Ortodonti</h1>
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                        <img class="img-fluid" src="{{asset('templates/img/carousel-2.jpg')}}" alt="">
                        <div class="owl-carousel-text">
                            <h1 class="display-1 text-white mb-0"> Spesialis Periodonsia</h1>
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                        <img class="img-fluid" src="{{asset('templates/img/carousel-3.jpg')}}" alt="">
                        <div class="owl-carousel-text">
                            <h1 class="display-1 text-white mb-0">Spesialis Kedokteran Gigi Anak</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <p class="text-white mb-4 pb-2">Klinik Gigi Sehat menawarkan lebih dari sekadar perawatan gigi; kami menyediakan pengalaman yang menyeluruh dan memuaskan untuk setiap pasien. Dengan tim dokter gigi berpengalaman yang mengutamakan kualitas dan kenyamanan, kami menggunakan teknologi terkini untuk memastikan hasil terbaik.</p>
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <h5 class="text-white mb-0">Doktor</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                ...
                <div class="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="{{asset('templates/img/feature.jpg')}}" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('templates/img/team-1.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('templates/img/team-2.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Doctor Name</h5>
                            <p class="text-primary">Department</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{ asset('templates/img/team-3.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Doctor Name</h5>
                            <p class="text-primary">Department</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{ asset('templates/img/team-4.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Doctor Name</h5>
                            <p class="text-primary">Department</p>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-4">Buatlah Janji Untuk Mengunjungi Dokter Kami</h1>
                    <p class="mb-4">Kami memahami betapa berharganya waktu Anda, oleh karena itu kami menyediakan layanan janji temu yang mudah dan fleksibel. Anda dapat mengatur jadwal kunjungan sesuai kenyamanan Anda melalui telepon, WhatsApp, atau sistem reservasi online kami yang user-friendly. </p>
                    <div class="bg-light rounded d-flex align-items-center p-5 mb-4">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">+628 1534 6511</h5>
                        </div>
                    </div>
                    <div class="bg-light rounded d-flex align-items-center p-5">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">klinik.gigi@gmail.com</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-light rounded h-100 d-flex align-items-center p-5 flex-column">
                        <div class='w-100' >
                            <?php
                            if(isset(Session::get('data')['name'])) {
                            ?>
                            <div class="alert alert-success mt-3" role="alert">
                                <h4 class="alert-heading">Terimakasih! {{ Session::get('data')['name'] }}</h4>
                                <p>Terimakasih telah membuat janji temu, kami akan segera menghubungi anda.</p>
                            </div>
                           <?php }?>
                        </div>
                        <form method="POST" action="/appointment" >
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <input name='name' type="text" class="form-control border-0"  placeholder="Nama anda" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input name='email' type="email" class="form-control border-0" placeholder="Email anda" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input name='hp' type="text" class="form-control border-0" placeholder="No. Handphone anda" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                ...
                                <div class="col-12">
                                    <textarea name='describe' class="form-control border-0" rows="5" placeholder="Jelaskan masalah anda"></textarea>
                                </div>
                                <div class="col-12">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center">
                    <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="{{ asset('templates/img/testimonial-1.jpg')}}" style="width: 100px; height: 100px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="{{ asset('templates/img/testimonial-2.jpg')}}" style="width: 100px; height: 100px;">
                    <div class="testimonial-text rounded text-center p-4">
                        <p>Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                        <h5 class="mb-1">Patient Name</h5>
                        <span class="fst-italic">Profession</span>
                ...
                <div class="testimonial-item text-center">
                    <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="{{ asset('templates/img/testimonial-3.jpg') }}" style="width: 100px; height: 100px;">
                    <div class="testimonial-text rounded text-center p-4">
                        <p>Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                        <h5 class="mb-1">Patient Name</h5>
                        <span class="fst-italic">Profession</span>
